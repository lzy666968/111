class Chatbot {
    constructor() {
        this.apiKey = 'sk-82a85752bd454ec19af382080a899e5f'; 
    ...
    init() {
        ...
        this.addBotMessage('你好！我是阿里云百炼AI助手，有什么我可以帮你的吗？');
    }
    ...
    async sendMessage() {
        ...
        try {
            ...
            const response = await this.callAliYun(message);
